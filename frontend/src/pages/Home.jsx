  ...
  const testimonials = [
    {
      ...
      company: "TechCorp",
      message: "FeedbackForm has revolutionized how we collect user feedback. The interface is intuitive and the analytics are incredibly helpful.",
      avatar: "SJ"
    },
    {
      name: "Michael Chen",
      ...
      company: "StartupXYZ",
      message: "We've seen a 300% increase in response rates since switching to FeedbackForm. The customization options are fantastic.",
      avatar: "MC"
    },
    {
      name: "Emily Davis",
